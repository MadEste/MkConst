...
// new using allows formatting rules
using Microsoft.CodeAnalysis.Formatting;

namespace MkConst
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(MkConstCodeFixProvider)), Shared]
    public class MkConstCodeFixProvider : CodeFixProvider
    {
        private const string title = "Make constant";

        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { return ImmutableArray.Create(MkConstAnalyzer.DiagnosticId); }
        }
